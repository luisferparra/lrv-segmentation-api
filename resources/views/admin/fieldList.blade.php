...
<td>
	@if(!is_null($datum->updated_at))
	{{$datum->updated_at->format('Y-m-d')}}
	@endif

</td>
<td><a href=""><button type="button" class="btn btn-primary"><i class="fa fa-edit"></i></button></a> </td>
</tr>
                        	@empty
        ...
        <div class="box-footer">
              <a href="{{route('AdminFieldsNew')}}">
                 <button type=button class="btn btn-info pull-right-container">Nuevo Campo</button></a>
              </div>
    </div>
