	...
	public function up()
	{
		Schema::create('dim_date', function(Blueprint $table)
		{
			...
			$table->char('fiscal_year_qtr', 10);
                ...
                DB::unprepared("CREATE PROCEDURE `PopulateDateDimension`(BeginDate DATETIME, EndDate DATETIME)
BEGIN
...
");
            ...
            DB::unprepared("CALL PopulateDateDimension('2010/01/01', '2030/12/31');");
            
            DB::unprepared('DROP PROCEDURE `PopulateDateDimension`');
